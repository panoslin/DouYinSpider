...
from mitmproxy import exceptions, main  # noqa
...
def run(
        main_cls: typing.Type[main.Main],
    ...
    try:
        ...
        for signame in ('SIGINT', 'SIGTERM'):
            try:
                loop.add_signal_handler(getattr(signal, signame), main.shutdown)
...
def mitmproxy(args=None) -> typing.Optional[int]:  # pragma: no cover
    ...
    run(console.main.ConsoleMain, cmdline.mitmproxy, args)
    return None
...
def mitmdump(args=None) -> typing.Optional[int]:  # pragma: no cover
    ...
    m = run(dump.DumpMain, cmdline.mitmdump, args, extra)
...
def mitmweb(args=None) -> typing.Optional[int]:  # pragma: no cover
    ...
    run(web.main.WebMain, cmdline.mitmweb, args)
    return None
