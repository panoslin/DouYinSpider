...
import mitmproxy.tools.console.main  # noqa
...
class FlowViewHeader(urwid.WidgetWrap):
    ...
    def __init__(
        self,
        main: "mitmproxy.tools.console.main.ConsoleMain",
    ) -> None:
        self.main = main
        self.focus_changed()
    ...
    def focus_changed(self):
        ...
        if self.main.view.focus.flow:
            self._w = common.format_flow(
                self.main.view.focus.flow,
                False,
                extended=True,
                hostheader=self.main.options.showhost,
                max_url_len=cols,
            )
        else:
            self._w = urwid.Pile([])
...
class FlowDetails(tabs.Tabs):
    ...
    def focus_changed(self):
        if self.main.view.focus.flow:
            ...
            self.main.window.pop()

    @property
    def view(self):
        return self.main.view

    @property
    def flow(self):
        return self.main.view.focus.flow
    ...
    def content_view(self, viewmode, message):
        if message.raw_content is None:
            ...
            full = self.main.commands.execute("view.getval @focus fullcontents false")
            if full == "true":
                limit = sys.maxsize
            else:
    ...
    def conn_text(self, conn):
        if conn:
            ...
            viewmode = self.main.commands.call("console.flowview.mode")
