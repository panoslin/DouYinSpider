...
class Adapter(tornado.wsgi.WSGIAdapter):
    ...
    # hideous monkey patch is the easiest way to get to the mitmproxy.main
    # variable.
    ...
    def application(self, request):
        request.main = self.environ["mitmproxy.main"]
...
class PEM(tornado.web.RequestHandler):
    ...
    def head(self):
        p = os.path.join(self.request.main.options.confdir, self.filename)
